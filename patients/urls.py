...
from .views import Search_Doctor_API, Doctor_Details_By_Username_API, Add_Bookings_API, Patient_Bookings_API
...
urlpatterns = [
    ...
    path('pt-appt/', Patient_Bookings_API.as_view(),name='pt-aapt-url'),
]